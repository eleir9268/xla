...
// Returns concrete tiles sizes for the given tiling space from the block level
// parameters. Tile size are returned as is (i.e. they are not rounded up to the
// next power of 2) and in the order as they appear in the tiling space.
